...
def initial_height(x,y):
    ...
    # NOTE the value of (0.3) should be positive due to the limit of shallow water equation

    # If we add the following h1 and return h0 + h1, it will be a two peaks distribution
...
def Centeroid(V,C):
    ...
    for i in range(NC):
        ...
        ####################################################################################
        # Calls the initial_height function to determine the inital distribution of the water height
